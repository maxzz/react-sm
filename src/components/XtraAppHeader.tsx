...
function GitHubSvg() {
    return (
        <svg className="" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
...
export function GithubLogoInline({ href }: { href: string; }) {
    return (
        <div className="">
            ...
            >
                <div className="w-4 h-4 p-[1px] border rounded text-blue-100 border-blue-100">
                    <GitHubSvg />
                </div>
            </a>
        </div>
...
function XtraAppHeader() {
    return (
        <div className="py-1 text-blue-900 flex items-center">
            ...
            <div className="ml-1 pb-0.5 text-xs text-blue-100">
